var questions = [
    {
        question: 'Who scored first thriple hundred in world cricket?',
        choices: ['Sachin Tendulkar', 'Kumar Sangakkara', 'Kusal Mendis', 'Brian Lara'],
        correctAnswer: 3
    },
    {
        question: 'Who is the highest wicket taker in international cricket?',
        choices: ['Shane Warne', 'Lakshan Sadakan', 'M.Murali', 'C Vass'],
        correctAnswer: 2
    },
    {
        question: 'Who is the best ODI batmen?',
        choices: ['Kusal mendis', 'Virat Kohli', 'Ms Dhoni', 'Brett Lee'],
        correctAnswer: 0
    },
    /*{
